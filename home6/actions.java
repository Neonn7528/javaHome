...
public class actions {
    ...
    public boolean notebookIsCorrect(Notebook notebook){
        ...
        for (Criterion criterion : criterionList){
            ...
            }else if (criterion.property.equals("memory")){
                valueNotebook = notebook.getMemory();
    ...
    public actions(Set<Notebook> notebooks) {
        actions.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    }

    public actions(Set<Notebook> notebooks, List<Criterion> criterionList) {
        actions.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    ...
    public int getCriteria(){
        String text = "Введите цифру - соответствующую действию: ";
        ...
        while (flag){
            ...
            if (operation.equals("3")){
                ...
                if (criterion - 1 < 0 || criterion - 1 > properties.size() - 1){
                    System.out.println("Введено не верно!!!");
                    continue;
                }
